...
from sklearn.metrics import f1_score, roc_auc_score,precision_recall_curve, accuracy_score,roc_curve
...
class KGCN(object):
    ...
    def _build_model(self, n_entity, n_relation):
        self.entity_emb_matrix = tf.get_variable(shape=[n_entity, self.dim], initializer=KGCN.get_initializer(), name='entity_emb_matrix')
        self.relation_emb_matrix = tf.get_variable(shape=[n_relation, self.dim], initializer=KGCN.get_initializer(), name='relation_emb_matrix')
    ...
    def eval(self, sess, feed_dict):
        ...
        return auc, aupr,f1, acc,  Pre, Sen, Spe, MCC
